...
lootTables.loot_totebot_green = {
	...
	randomLoot = {
		{ uuid = obj_resource_circuitboard,		chance = 1 },
		{ uuid = obj_decor_screw01,		chance = 1,	quantity = 5  },
		{ uuid = obj_decor_screw02,		chance = 1,	quantity = 5  },
	}
}
...
lootTables.loot_haybot = {
	...
	randomLoot = {
		...
		{ uuid = obj_decor_screw01,		chance = 1,	quantity = 1  },
		{ uuid = obj_decor_screw02,		chance = 1,	quantity = 1  },
	}
}
...
SelectLoot = function( lootTableName, slotLimit )
	print("---------------------")
	local lootList = {}
